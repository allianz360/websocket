...
<script type="text/javascript">
	...
	function userOnline(userId) {
		var html = '<a href="javascript:;" id="' + userId
				+ '" class="list-group-item text-left" onclick="showChatDiv(\''
				+ userId + '\')">';
		...
		html += userId + '</a>';
		$("#friendsDiv .list-group").append(html);
	}
...
<body>
	...
	<div id="friendsDiv">
		...
		<div class="list-group" style="height: 400px; overflow: auto;">
			<!-- <a href="#" class="list-group-item text-left" onclick="showChatDiv()"><img
				width="40"
	...
	<div id="chatDiv" style="display: none;">
		<a href="#" class="list-group-item active"> 消息列表 </a>
		...
		<div class="form-group navbar-fixed-bottom">
			...
			<div class="input-group">
				<div class="input-group-addon" onclick="showFriendsDiv()">&lt;</div>
				<input type="text" class="form-control" id="msgText"
					placeholder="输入消息"> <input type="hidden" id="userId" />
